...
const Product = () => {
    ...
    const SetSelectedColor = (e,c) => {
        color !== c &&  setSelectedColors({
            ...selectedColors,
    ...
    const handleClick = () => {
        color && size && dispatch(addProduct({ ...product, quantity, color, size }));
    }
                    ...
                    <FilterContainer>
                        <Filter>
                            <FilterTitle>Color</FilterTitle>
                            {
                                ...
                                (
                                    <FilterColor
                                        isSelected={selectedColors[c]}
                                        color={c}
                                        key={c}
                                        onClick={(e) => SetSelectedColor(e,c)}>
                                    </FilterColor>
                                ))
                            }
                        </Filter>
